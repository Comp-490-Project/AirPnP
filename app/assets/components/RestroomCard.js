...
function RestroomCard({ navigation, name, address, latitude, longitude, geohash, indexValue  }) {
   
    return (
        <LinearGradient
        start={{ x: 0, y: 0 }}
        end={{ x: 1, y: 0 }}
        colors={indexValue % 2 == 0 ? ([colors.firstfavColorLeft, colors.firstfavColorRight]):([colors.secondFavColorLeft, colors.secondFavColorRight])}         
        locations={[0, 0.7]}
